...
//consigue la altura de cada bloque por separado (por eso esta el array alturas)
    ...
    public boolean colision(int x, int y, int width, int height) {
    	// se supone que maneja las colisiones con cada borde de los bloques. No funciona, solo colisiona con el borde superior del cuadrado
        ...
        // Verifica la colisión en los bordes laterales del bloque, teniendo en cuenta la atravesabilidad ----- ESTO TAMPOCO FUNCIONA ----- 
